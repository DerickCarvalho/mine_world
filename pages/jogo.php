...
<section class="game-screen" data-game-root data-world-id="<?php echo $requestedWorldId; ?>">
    ...
    <div class="game-hud">
        <div class="game-hud__top">
            <a class="game-hud__back" href="index.php?page=mundos">Voltar aos mundos</a>
    ...
    <div class="game-instruction" data-overlay-instruction hidden>
        Clique na cena para capturar o mouse. Use WASD para andar, espaco para pular e ESC para liberar o cursor.
    </div>
    ...
    <div class="game-overlay" data-scene-overlay>
        <div class="game-overlay__card">
            ...
            <p class="game-overlay__hint">Primeira versao jogavel: terreno procedural, camera em primeira pessoa e movimento basico.</p>
