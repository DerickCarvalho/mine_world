<section class="menu-screen">
    <p class="menu-screen__eyebrow">Menu principal</p>
    <h1>MineWorld</h1>
    <p class="menu-screen__copy">Escolha a proxima area do sandbox. Mundos, texturas, comandos e configuracoes usam a mesma sessao autenticada.</p>
...
<button class="button button--ghost menu-screen__button" type="button" data-nav-page="comandos">Comandos</button>
    ...
    <div class="menu-screen__status">
        <span class="menu-screen__status-label">Conta carregada</span>
        <strong data-auth-user-name>Jogador</strong>
    </div>
</section>
