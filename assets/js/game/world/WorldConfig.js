export const WORLD_CONFIG = Object.freeze({
    ...
    stepHeight: 0.65,
    baseMoveSpeed: 6.2,
    sprintMoveMultiplier: 1.45,
    crouchMoveMultiplier: 0.38,
    crouchCameraOffset: 0.55,
    crouchEdgeTolerance: 0.08,
    waterMoveSpeed: 3.1,
    waterVerticalSpeed: 3.4,
    waterGravity: 5.2,
    waterIdleSinkSpeed: 0.45,
    flightMoveSpeed: 6.8,
    flightVerticalSpeed: 5.8,
    jumpVelocity: 8.7,
    gravity: 30,
    maxHealth: 10,
    maxHunger: 10,
    hungerDrainInterval: 24,
    starvationDamageInterval: 4.8,
    fallDamageStart: 4,
    fov: 78,
    nearPlane: 0.1,
    farPlane: 190
